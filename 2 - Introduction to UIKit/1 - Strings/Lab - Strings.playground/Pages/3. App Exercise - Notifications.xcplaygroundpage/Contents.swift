 ...
 */
let firstName: String = "Makhkambek"
let lastName: String = " Teshabayev"
...
let newBest = 15125
let congratulations: String = fullName
print("Congratulations, \(fullName)! You beat your beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday")
