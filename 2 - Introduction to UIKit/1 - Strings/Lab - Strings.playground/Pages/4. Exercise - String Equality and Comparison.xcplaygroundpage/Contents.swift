 ...
 */
let nameInCaps: String = "MAKHKAMBEK"
let name: String = "makhkambek"
if nameInCaps == name {
...
if nameInCaps.lowercased() == name.lowercased(){
    print("<INSERT LOWERCASED VERSION OF nameInCaps HERE> and <INSERT LOWERCASED VERSION OF name HERE> are the same.")
} else if (nameInCaps.lowercased() != name.lowercased()){
    print("<INSERT LOWERCASED VERSION OF nameInCaps HERE> and <INSERT LOWERCASED VERSION OF name HERE> are not the same.")
}
