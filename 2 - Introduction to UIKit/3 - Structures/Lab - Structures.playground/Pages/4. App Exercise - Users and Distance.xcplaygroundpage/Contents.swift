...
let user = User(name: "Makhkambek", age: 16, height: 175, weight: 59.5, activityLevel: 10)
print(user.activityLevel)
//:  Create a variable instance of `User` and call it your name. Use the memberwise initializer to pass in information about yourself. Then print out a description of your `User` instance using the instance's properties.
var yourname = User(name: "Makhkambek", age: 16, height: 175, weight: 59.5, activityLevel: 10)
print("\(yourname.name), \(yourname.age), \(yourname.height), \(yourname.weight), \(yourname.activityLevel)")
/*:
...
var kilometer = Distance(feet: 5200)
