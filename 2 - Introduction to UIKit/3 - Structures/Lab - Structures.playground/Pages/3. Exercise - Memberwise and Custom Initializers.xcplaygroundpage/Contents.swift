...
let book = favoriteBook(book: "to be or not to be", title: 666, author: "me", price: 99.99)
print(book.book)
/*:
...
let newLaptop = laptop(screenSize: 16, repairCount: 0, yearPurchased: 2021)
print(newLaptop.yearPurchased)
...
let inch = Height(inches: 65.5)
print(inch.heightInCentimeters)
