...
let tranning = RunningWorkout(distance: 3000, time: 120, elevation: 100)
print(tranning.avarageMileTime)
...
struct Steps {
    var steps: Int {
        willSet {
            if steps == goal {
                print("Congratulation, u beat your goal")
            }
        }
    }
    var goal: Int
...
var step = Steps(steps: 10_001, goal:9_999)
step.takeStep()
