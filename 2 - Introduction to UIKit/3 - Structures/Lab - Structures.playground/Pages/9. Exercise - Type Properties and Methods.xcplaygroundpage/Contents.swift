...
struct User {
    ...
    static var currentUser = User(userName: "Makhkambek", email: "okeydokeykokki@gmail.com", age: 16)
 ...
 */
User.login(user: User(userName: "Makhkambek", email: "okeydokeykokki@gmail.com", age: 16))
