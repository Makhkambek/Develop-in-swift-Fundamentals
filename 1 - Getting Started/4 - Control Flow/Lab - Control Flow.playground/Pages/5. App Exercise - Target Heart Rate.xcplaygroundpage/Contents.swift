...
let currentHR = 147
var isInTarget = 147
var isBelowTarget = 110
var isAboveTarget = 170
if isBelowTarget <= targetLowerBound {
    print("Youre right on track")
} else if (isInTarget == currentHR){
    print("youre doing great, but try to push it a bit")
