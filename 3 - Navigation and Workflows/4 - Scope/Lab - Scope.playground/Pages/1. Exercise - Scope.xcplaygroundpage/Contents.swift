...
//print("The value of foo is \(foo)")
//мы не можем написать так, потому что тут print используется за скобками
...
//мы можем распечатать это потому что x это глобальная переменная и мы можем использовать ее как в скобках так и вне скобок
